...
open class ACTabScrollView: UIView, UIScrollViewDelegate {
    ...
    override open func prepareForInterfaceBuilder() {
        ...
        if #available(iOS 8.2, *) {
            tabSectionLabel.font = UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.heavy)
        } else {
            tabSectionLabel.font = UIFont.systemFont(ofSize: 20)
        }
        ...
        if #available(iOS 8.2, *) {
            contentSectionLabel.font = UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.heavy)
        } else {
            contentSectionLabel.font = UIFont.systemFont(ofSize: 20)
        }
